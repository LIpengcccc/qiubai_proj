...
class MySQLPipeLine(object):
    ...
    def db_insert_handle(self, cursor, item):
        ...
        insert_sql = """
						 insert into toscrape(img_url, detail_url, book_name,book_price,book_description)
						 VALUES(%s,%s,%s,%s,%s)
					 """
        item_values = (item['img_url'], item['detail_url'], item['book_name'],
                       item['book_price'], pymysql.escape_string(item['book_description']))
        # pymysql.escape_string(item['book_description'])
